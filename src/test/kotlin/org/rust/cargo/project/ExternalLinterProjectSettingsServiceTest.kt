...
class ExternalLinterProjectSettingsServiceTest : LightPlatformTestCase() {
    ...
    fun `test serialization`() {
        val service = ExternalLinterProjectSettingsService(project)
    ...
    companion object {
        private fun stateFromXmlString(xml: String): ExternalLinterProjectSettingsService.State {
            val element = elementFromXmlString(xml)
            return XmlSerializer.deserialize(element, ExternalLinterProjectSettingsService.State::class.java)
        }
    }
}

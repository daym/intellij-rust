...
val RustProjectSettingsService.rustfmt: RustfmtProjectSettingsService
    get() = project.getService(RustfmtProjectSettingsService::class.java)
...
class RustfmtProjectSettingsService(project: Project) : RsProjectSettingsServiceBase<State>(project, State()) {
    ...
    override fun noStateLoaded() {
        ...
        modify {
            it.useRustfmt = rustSettings.state.useRustfmt
            rustSettings.state.useRustfmt = false
            it.runRustfmtOnSave = rustSettings.state.runRustfmtOnSave
            rustSettings.state.runRustfmtOnSave = false
        }
    }
